...
SPELL_FUN *spell_function( char *name )
{
    ...
    if ( !str_cmp( name, "spell_astral_blade" ))     return spell_astral_blade;
    ...
    if ( !str_cmp( name, "spell_transfer_energy" ))  return spell_transfer_energy;
...
DO_FUN *skill_function( char *name )
{
	...
	if ( !str_cmp( name, "do_fletch" ))		return do_fletch;
	...
	break;
    case 'k':
	if ( !str_cmp( name, "do_kanaly" ))		return do_kanaly;
	...
	if ( !str_cmp( name, "do_leavecla" ))		return do_leavecla;
	if ( !str_cmp( name, "do_leaveclan" ))		return do_leaveclan;
	...
	if ( !str_cmp( name, "do_modstat" ))		return do_modstat;
	...
	if ( !str_cmp( name, "do_odmie" ))		return do_odmie;
	if ( !str_cmp( name, "do_odmien" ))		return do_odmien;
	if ( !str_cmp( name, "do_oodstat" ))		return do_oodstat;
...
/*	if ( !str_cmp( name, "do_qpset" ))		return do_qpset;
	...
	if ( !str_cmp( name, "do_showchannel" ))	return do_showchannel;
	...
	if ( !str_cmp( name, "do_update_channels" ))	return do_update_channels;
...
char *spell_name( SPELL_FUN *spell )
{
    ...
    if ( spell == spell_astral_blade )	    return "spell_astral_blade";
    ...
    if ( spell == spell_transfer_energy )   return "spell_transfer_energy";
...
char *skill_name( DO_FUN *skill )
{
    ...
    if ( skill == do_fletch )		return "do_fletch";
    ...
    if ( skill == do_kanaly )		return "do_kanaly";
    ...
    if ( skill == do_leavecla ) 	return "do_leavecla";
    if ( skill == do_leaveclan )	return "do_leaveclan";
    ...
    if ( skill == do_modstat )		return "do_modstat";
    ...
    if ( skill == do_odmie )		return "do_odmie";
    if ( skill == do_odmien )		return "do_odmien";
    if ( skill == do_oodstat )		return "do_oodstat";
...
/*    if ( skill == do_qpset )		return "do_qpset";
    ...
    if ( skill == do_showchannel )	return "do_showchannel";
    ...
    if ( skill == do_update_channels )	return "do_update_channels";
