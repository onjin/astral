...
/*	if (imc)
	...
	else if ( !str_cmp( arg, "copy" ) )
	{
	  if ( !IS_IMMORTAL(ch) )
	  {
	    send_to_char( "Ze co?  Type 'help note' for usage.\n\r", ch );
	    return;
	  }
	  take = 2;
	}
...
void do_bset( CHAR_DATA *ch, char *argument )
{
	...
	write_boards_txt( );
	send_to_char( "Zrobione.  (board's object vnum set)\n\r", ch );
	return;
    }
	...
	write_boards_txt( );
	send_to_char( "Zrobione.  (minimum reading level set)\n\r", ch );
	return;
    }
	...
	write_boards_txt( );
	send_to_char( "Zrobione.  (reading group set)\n\r", ch );
	return;
    }
	...
	write_boards_txt( );
	send_to_char( "Zrobione.  (posting group set)\n\r", ch );
	return;
    }
   ...
   if ( !str_cmp( arg2, "extra_removers" ) )
    {
        ...
        write_boards_txt( );
        send_to_char( "Zrobione.  (extra removers set)\n\r", ch );
        return;
    }
	...
	write_boards_txt( );
	send_to_char( "Zrobione.  (extra readers set)\n\r", ch );
	return;
    }
	...
	write_boards_txt( );
	send_to_char( "Zrobione.  (board's filename set)\n\r", ch );
	return;
    }
	...
	write_boards_txt( );
	send_to_char( "Zrobione.  (minimum posting level set)\n\r", ch );
	return;
    }
	...
	write_boards_txt( );
	send_to_char( "Zrobione.  (minimum remove level set)\n\r", ch );
	return;
    }
	...
	write_boards_txt( );
	send_to_char( "Zrobione.  (maximum number of posts set)\n\r", ch );
	return;
    }
	...
	board->type = value;
	write_boards_txt( );
	send_to_char( "Zrobione.  (board's type set)\n\r", ch );
	return;
    }
