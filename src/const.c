...
const   struct  race_type       _race_table      [MAX_RACE]      =
{
    ...
    {
	"_Demon_",   {{1<<AFF_DETECT_HIDDEN,0,0,0}},   -1, 2, 2, 2, 2,-2, -2,	0,												    LANG_COMMON
    },
    {
...
{
"human", "elf", "dwarf", "halfling", "pixie", "vampir", "half-ogre",
"half-orc", "half-troll", "half-elf", "gith", "drow", "sea-elf",
"lizardman", "gnome", "demon", "r5", "r6", "r7", "r8", "troll",
...
"augurer", "assassin", "demon", "angel", "paladin", "nephandi", "savage", 
"pirate", "pc12", "pc13", "pc14", "pc15", "pc16", "pc17", "pc18", "pc19", 
...
{
    { "woda",			"przezroczystego",	{  0, 1, 10 }	},  /*  0 */
    { "piwo",			"bursztynowego",	{  3, 2,  5 }	},
    { "wino",			"czerwonego",		{  5, 2,  5 }	},
    { "ale",			"brazowego",	{  2, 2,  5 }	},
    { "ciemne ale",		"ciemnego",		{  1, 2,  5 }	},

    { "whisky",			"zlotego",	{  6, 1,  4 }	},  /*  5 */
    { "lemoniada",		"rozowego",		{  0, 1,  8 }	},
    { "gardlogrzmot",		"wrzacego",	{ 10, 0,  0 }	},
    { "lokalna specjalnosc",	"przezroczystego",	{  3, 3,  3 }	},
    { "slime mold juice",	"zielonego",	{  0, 4, -8 }	},

    { "mleko",			"bialego",	{  0, 3,  6 }	},  /* 10 */
    { "herbata",		"brazowego",		{  0, 1,  6 }	},
    { "kawa",			"czrnego",	{  0, 1,  6 }	},
    { "krew",			"czerwonego",		{  0, 2, -1 }	},
    { "slona woda",		"czystego",	{  0, 1, -2 }	},

    { "cola",			"wisniowego",	{  0, 1,  5 }	},  /* 15 */
    { "miod",			"miodowego",	{  4, 2,  5 }	},  /* 16 */
    { "grog",			"jasno brazowego",	{  3, 2,  5 }	}   /* 17 */
};

char *	const	attack_table	[18] =
{
    "uderzenie",
    "ciecie",  "dzgniecie", "ciecie", "smagniecie",
    "drapniecie",
    "dmuchniecie",  "walniecie", "gniecenie", "miazdzenie",
    "ugryzienie",
    "pchniecie", "ssanie", "belt",  "strzala",
    "strzalka",
    "kamien",  "rzut"
};
...
{
	"Nie trafiasz", "Lekko drapiesz", "Drapiesz", "Nacinasz", "Tniesz", "Trafiasz",
	"Rozpruwasz",
	"Rozrywasz", "Rozcinasz", "Ranisz", "Rabiesz", "Tluczesz", "Rozrywasz",
	"Cwiartujesz",
	"_Rozszarpujesz_", "_Dewastujesz_", "_Rozlupujesz_", "_Masakrujesz_",
	"WYPATRASZASZ",
	"OSZPECASZ", "CWIARTUJESZ", "NISZCZYSZ", "* ZARZYNASZ *",
        "*** UNICESTWIASZ ***"
};

char * p_blade_messages[24] =
{
	"nie trafia", "zadrapuje", "drapie", "nacina", "tnie", "trafia",
	"rozpruwa", "rozrywa", "rozcina", "rani", "rabie", "tlucze", "rozrywa",
	"cwiartuje", "_rozrywa_", "_dewastuje_", "_rozlupuje_", "_masakruje_",
	"WYPATRASZA", "OSZPECA", "CWIARTUJE", "NISZCZY", "* ZARZYNA *",
	"*** UNICESTWIA ***"
};
