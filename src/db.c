...
void load_mobiles( AREA_DATA *tarea, FILE *fp )
{
    ...
    if ( area_version > 1 ) /* Flash */
	{
	pMobIndex->short_descr_dop	= fread_string( fp );
	pMobIndex->short_descr_cel	= fread_string( fp );
	pMobIndex->short_descr_bie	= fread_string( fp );
	pMobIndex->short_descr_nar	= fread_string( fp );
	pMobIndex->short_descr_mie	= fread_string( fp );
	pMobIndex->short_descr_wol	= fread_string( fp );
	}
    else
	{
	pMobIndex->short_descr_dop	= pMobIndex->short_descr;
	pMobIndex->short_descr_cel	= pMobIndex->short_descr;
	pMobIndex->short_descr_bie	= pMobIndex->short_descr;
	pMobIndex->short_descr_nar	= pMobIndex->short_descr;
	pMobIndex->short_descr_mie	= pMobIndex->short_descr;
	pMobIndex->short_descr_wol	= pMobIndex->short_descr;
	}
...
void load_objects( AREA_DATA *tarea, FILE *fp )
{
    ...
    if ( area_version > 2 ) /* Flash */
	{
	pObjIndex->short_descr_dop	= fread_string( fp );
	pObjIndex->short_descr_cel	= fread_string( fp );
	pObjIndex->short_descr_bie	= fread_string( fp );
	pObjIndex->short_descr_nar	= fread_string( fp );
	pObjIndex->short_descr_mie	= fread_string( fp );
	pObjIndex->short_descr_wol	= fread_string( fp );
	}
	else	
	{
	pObjIndex->short_descr_dop	= pObjIndex->short_descr;
	pObjIndex->short_descr_cel	= pObjIndex->short_descr;
	pObjIndex->short_descr_bie	= pObjIndex->short_descr;
	pObjIndex->short_descr_nar	= pObjIndex->short_descr;
	pObjIndex->short_descr_mie	= pObjIndex->short_descr;
	pObjIndex->short_descr_wol	= pObjIndex->short_descr;
	}
...
void area_update( void )
{
	...
	if ( pArea->nplayer > 0 && pArea->age == (reset_age-1) )
	{
		...
		strcpy( buf, "Slyszysz jakis dziwny dzwiek...\n\r" );
...
CHAR_DATA *create_mobile( MOB_INDEX_DATA *pMobIndex )
{
    ...
    mob->short_descr_dop	= QUICKLINK( pMobIndex->short_descr_dop );
    mob->short_descr_cel	= QUICKLINK( pMobIndex->short_descr_cel );
    mob->short_descr_bie	= QUICKLINK( pMobIndex->short_descr_bie );
    mob->short_descr_nar	= QUICKLINK( pMobIndex->short_descr_nar );
    mob->short_descr_mie	= QUICKLINK( pMobIndex->short_descr_mie );
    mob->short_descr_wol	= QUICKLINK( pMobIndex->short_descr_wol );
...
OBJ_DATA *create_object( OBJ_INDEX_DATA *pObjIndex, int level )
{
    ...
    obj->short_descr_dop= QUICKLINK( pObjIndex->short_descr_dop );
    obj->short_descr_cel= QUICKLINK( pObjIndex->short_descr_cel );
    obj->short_descr_bie= QUICKLINK( pObjIndex->short_descr_bie );
    obj->short_descr_nar= QUICKLINK( pObjIndex->short_descr_nar );
    obj->short_descr_mie= QUICKLINK( pObjIndex->short_descr_mie );
    obj->short_descr_wol= QUICKLINK( pObjIndex->short_descr_wol );
...
void clear_char( CHAR_DATA *ch )
{
    ...
    ch->nwol			= NULL;
    ch->short_descr		= NULL;
    ch->short_descr_dop		= NULL;
    ch->short_descr_cel		= NULL;
    ch->short_descr_bie		= NULL;
    ch->short_descr_nar		= NULL;
    ch->short_descr_mie		= NULL;
    ch->short_descr_wol		= NULL;
    ch->long_descr		= NULL;
    ch->description		= NULL;
    ch->next			= NULL;
    ch->prev			= NULL;
...
void free_char( CHAR_DATA *ch )
{
    ...
    STRFREE( ch->short_descr_dop);
    STRFREE( ch->short_descr_cel);
    STRFREE( ch->short_descr_bie);
    STRFREE( ch->short_descr_nar);
    STRFREE( ch->short_descr_mie);
    STRFREE( ch->short_descr_wol);
...
void bug( const char *str, ... )
{
    ...
    if ( fpArea != NULL ) { 
		...
		if ( fpArea == stdin ) {
		    ...
		    iChar = ftell( fpArea ); //Flash tu sie sypie fix_exits()
		    fseek( fpArea, 0, 0 );
...
bool delete_mob( MOB_INDEX_DATA *mob )
{
  ...
  STRFREE(mob->short_descr_dop);
  STRFREE(mob->short_descr_cel);
  STRFREE(mob->short_descr_bie);
  STRFREE(mob->short_descr_nar);
  STRFREE(mob->short_descr_mie);
  STRFREE(mob->short_descr_wol);
...
OBJ_INDEX_DATA *make_object( int vnum, int cvnum, char *name )
{
	...
	if ( !cObjIndex )
	{
	  ...
	  pObjIndex->short_descr_dop	= STRALLOC( buf  );
	  pObjIndex->short_descr_cel	= STRALLOC( buf  );
	  pObjIndex->short_descr_bie	= STRALLOC( buf  );
	  pObjIndex->short_descr_nar	= STRALLOC( buf  );
	  pObjIndex->short_descr_mie	= STRALLOC( buf  );
	  pObjIndex->short_descr_wol	= STRALLOC( buf  );
	  sprintf( buf, "Some god dropped a newly created %s here.", name );
	  pObjIndex->description	= STRALLOC( buf );
	  pObjIndex->action_desc	= STRALLOC( "" );
	  pObjIndex->short_descr[0]	= LOWER(pObjIndex->short_descr[0]);
	  pObjIndex->short_descr_dop[0]	= LOWER(pObjIndex->short_descr_dop[0]);
	  pObjIndex->short_descr_cel[0]	= LOWER(pObjIndex->short_descr_cel[0]);
	  pObjIndex->short_descr_bie[0]	= LOWER(pObjIndex->short_descr_bie[0]);
	  pObjIndex->short_descr_nar[0]	= LOWER(pObjIndex->short_descr_nar[0]);
	  pObjIndex->short_descr_mie[0]	= LOWER(pObjIndex->short_descr_mie[0]);
	  pObjIndex->short_descr_wol[0]	= LOWER(pObjIndex->short_descr_wol[0]);
	  pObjIndex->description[0]	= UPPER(pObjIndex->description[0]);
	...
	else
	{
	  ...
	  pObjIndex->short_descr_dop	= QUICKLINK( cObjIndex->short_descr_dop );
	  pObjIndex->short_descr_cel	= QUICKLINK( cObjIndex->short_descr_cel );
	  pObjIndex->short_descr_bie	= QUICKLINK( cObjIndex->short_descr_bie );
	  pObjIndex->short_descr_nar	= QUICKLINK( cObjIndex->short_descr_nar );
	  pObjIndex->short_descr_mie	= QUICKLINK( cObjIndex->short_descr_mie );
	  pObjIndex->short_descr_wol	= QUICKLINK( cObjIndex->short_descr_wol );
...
MOB_INDEX_DATA *make_mobile( int vnum, int cvnum, char *name )
{
	...
	if ( !cMobIndex )
	{
	  ...
	  pMobIndex->short_descr_dop[0]	= LOWER(pMobIndex->short_descr_dop[0]);
	  pMobIndex->short_descr_cel[0]	= LOWER(pMobIndex->short_descr_cel[0]);
	  pMobIndex->short_descr_bie[0]	= LOWER(pMobIndex->short_descr_bie[0]);
	  pMobIndex->short_descr_nar[0]	= LOWER(pMobIndex->short_descr_nar[0]);
	  pMobIndex->short_descr_mie[0]	= LOWER(pMobIndex->short_descr_mie[0]);
	  pMobIndex->short_descr_wol[0]	= LOWER(pMobIndex->short_descr_wol[0]);
	  pMobIndex->long_descr[0]	= UPPER(pMobIndex->long_descr[0]);
	  pMobIndex->description[0]	= UPPER(pMobIndex->description[0]);
	...
	else
	{
	  ...
	  pMobIndex->short_descr_dop	= QUICKLINK( cMobIndex->short_descr_dop );
	  pMobIndex->short_descr_cel	= QUICKLINK( cMobIndex->short_descr_cel );
	  pMobIndex->short_descr_bie	= QUICKLINK( cMobIndex->short_descr_bie );
	  pMobIndex->short_descr_nar	= QUICKLINK( cMobIndex->short_descr_nar );
	  pMobIndex->short_descr_mie	= QUICKLINK( cMobIndex->short_descr_mie );
	  pMobIndex->short_descr_wol	= QUICKLINK( cMobIndex->short_descr_wol );
