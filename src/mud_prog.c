...
/* Flash zmienne prog koniec */
         ...
         if ( v_obj && !obj_extracted(v_obj) )
	 {
	   can_see_obj( mob, v_obj ) ? strcpy( t, v_obj->short_descr )
	      ...
	      strcpy( t, "cos" );
      break;
/* Flash zmienne przedmiotow */    

     case 'f':
         if ( obj && !obj_extracted(obj) )
	 {
	   can_see_obj( mob, obj ) ? strcpy( t, obj->short_descr_dop )
                                   : strcpy( t, "czegos" );
         }
	 else
	      strcpy( t, "czegos" );
     ...
     case 'F':
         if ( v_obj && !obj_extracted(v_obj) )
	 {
	   can_see_obj( mob, v_obj ) ? strcpy( t, v_obj->short_descr_dop )
                                     : strcpy( t, "czegos" );
         }
	 else
	      strcpy( t, "czegos" );
     ...
     case 'h':
         if ( obj && !obj_extracted(obj) )
	 {
	   can_see_obj( mob, obj ) ? strcpy( t, obj->short_descr_cel )
                                   : strcpy( t, "czemus" );
         }
	 else
	      strcpy( t, "czemus" );
     ...
     case 'H':
         if ( v_obj && !obj_extracted(v_obj) )
	 {
	   can_see_obj( mob, v_obj ) ? strcpy( t, v_obj->short_descr_cel )
                                     : strcpy( t, "czemus" );
         }
	 else
	      strcpy( t, "czemus" );
     ...
     case 'v':
         if ( obj && !obj_extracted(obj) )
	 {
	   can_see_obj( mob, obj ) ? strcpy( t, obj->short_descr_bie )
                                   : strcpy( t, "cos" );
         }
	 else
	      strcpy( t, "cos" );
     ...
     case 'V':
         if ( v_obj && !obj_extracted(v_obj) )
	 {
	   can_see_obj( mob, v_obj ) ? strcpy( t, v_obj->short_descr_bie )
                                     : strcpy( t, "cos" );
         }
	 else
	      strcpy( t, "cos" );
     ...
     case 'y':
         if ( obj && !obj_extracted(obj) )
	 {
	   can_see_obj( mob, obj ) ? strcpy( t, obj->short_descr_nar )
                                   : strcpy( t, "czyms" );
         }
	 else
	      strcpy( t, "czyms" );
     ...
     case 'Y':
         if ( v_obj && !obj_extracted(v_obj) )
	 {
	   can_see_obj( mob, v_obj ) ? strcpy( t, v_obj->short_descr_nar )
                                     : strcpy( t, "czyms" );
         }
	 else
	      strcpy( t, "czyms" );
     ...
     case 'u':
         if ( obj && !obj_extracted(obj) )
	 {
	   can_see_obj( mob, obj ) ? strcpy( t, obj->short_descr_mie )
                                   : strcpy( t, "czyms" );
         }
	 else
	      strcpy( t, "czyms" );
     ...
     case 'U':
         if ( v_obj && !obj_extracted(v_obj) )
	 {
	   can_see_obj( mob, v_obj ) ? strcpy( t, v_obj->short_descr_mie )
                                     : strcpy( t, "czyms" );
         }
	 else
	      strcpy( t, "czyms" );
     ...
     case '1':
         if ( obj && !obj_extracted(obj) )
	 {
	   can_see_obj( mob, obj ) ? strcpy( t, obj->short_descr_wol )
                                   : strcpy( t, "cos" );
         }
	 else
	      strcpy( t, "cos" );
     ...
     case '2':
         if ( v_obj && !obj_extracted(v_obj) )
	 {
	   can_see_obj( mob, v_obj ) ? strcpy( t, v_obj->short_descr_wol )
                                     : strcpy( t, "cos" );
         }
	 else
	      strcpy( t, "cos" );
      break;
/* Flash zmienne przedmiotow - koniec */
...
void set_supermob( OBJ_DATA *obj)
{
  ...
  if (supermob->short_descr_dop)
     STRFREE(supermob->short_descr_dop);
  if (supermob->short_descr_cel)
     STRFREE(supermob->short_descr_cel);
  if (supermob->short_descr_bie)
     STRFREE(supermob->short_descr_bie);
  if (supermob->short_descr_nar)
     STRFREE(supermob->short_descr_nar);
  if (supermob->short_descr_mie)
     STRFREE(supermob->short_descr_mie);
  if (supermob->short_descr_wol)
     STRFREE(supermob->short_descr_wol);

  supermob->short_descr = QUICKLINK(obj->short_descr);
  supermob->short_descr_dop = QUICKLINK(obj->short_descr_dop);
  supermob->short_descr_cel = QUICKLINK(obj->short_descr_cel);
  supermob->short_descr_bie = QUICKLINK(obj->short_descr_bie);
  supermob->short_descr_nar = QUICKLINK(obj->short_descr_nar);
  supermob->short_descr_mie = QUICKLINK(obj->short_descr_mie);
  supermob->short_descr_wol = QUICKLINK(obj->short_descr_wol);
...
void rset_supermob( ROOM_INDEX_DATA *room)
{
  ...
  if (room)
  {
    ...
    STRFREE(supermob->short_descr_dop);
    supermob->short_descr_dop = QUICKLINK(room->name);
    STRFREE(supermob->short_descr_cel);
    supermob->short_descr_cel = QUICKLINK(room->name);
    STRFREE(supermob->short_descr_bie);
    supermob->short_descr_bie = QUICKLINK(room->name);
    STRFREE(supermob->short_descr_nar);
    supermob->short_descr_nar = QUICKLINK(room->name);
    STRFREE(supermob->short_descr_mie);
    supermob->short_descr_mie = QUICKLINK(room->name);
    STRFREE(supermob->short_descr_wol);
    supermob->short_descr_wol = QUICKLINK(room->name);
